...
namespace Bloomie.Areas.Admin.Controllers
{
    ...
    public class AdminProductDiscountController : Controller
    {
        ...
        public AdminProductDiscountController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: Admin/AdminProductDiscount
        ...
        // GET: Admin/AdminProductDiscount/Create
        ...
        // POST: Admin/AdminProductDiscount/Create
        [HttpPost]
        ...
        public async Task<IActionResult> Create(ProductDiscountVM model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("ManageCampaigns", "AdminPromotion");
                }
            }
        ...
        // GET: Admin/AdminProductDiscount/Edit/5
        ...
        // POST: Admin/AdminProductDiscount/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: Admin/AdminProductDiscount/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: Admin/AdminProductDiscount/ToggleActive/5
        [HttpPost]
        [ValidateAntiForgeryToken]
